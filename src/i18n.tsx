...
const ZH: Record<string, string> = {
  ...
  "Proposed a plan for your review.": "已生成 Skill 方案，请检查。",
  "Proposed an automation plan for your review.": "已生成自动化方案，请检查。",
  "Received the finished skill.": "已收到完成的 Skill。",
  "Stopping…": "正在停止…",
  ...
  "Create another Skill →": "再创建一个 Skill →",
  "Open skill →": "打开 Skill →",
  "Open automation →": "打开自动化 →",
  "Open scheduled Skill →": "打开定时 Skill →",
  "Turn this recording into a skill or an automation": "将这条录制转换为 Skill 或自动化",
  "Skill created": "Skill 已创建",
  "Automation created": "自动化已创建",
  "Skill & automation created": "Skill 与自动化均已创建",
  "Create": "创建",
  "What do you want to build from this recording?": "你想用这条录制构建什么？",
  "Coming soon": "即将推出",
  "Back to the analysis": "返回分析",
  "Previous": "上一步",
  "Opening the skill…": "正在打开 Skill…",
  "Opening the automation…": "正在打开定时 / 自动触发的 Skill…",
  "Planning the skill…": "正在规划 Skill…",
  "Planning the automation…": "正在规划定时 / 自动触发的 Skill…",
  "Writing the skill…": "正在生成 Skill…",
  "Writing the automation…": "正在生成定时 / 自动触发的 Skill…",
  "Exporting the skill…": "正在导出 Skill…",
  "What the skill will do": "Skill 将完成什么",
  "What the automation will do": "自动化将完成什么",
  "What the scheduled Skill will do": "定时 / 自动触发的 Skill 将完成什么",
  "When it runs": "运行时间",
  ...
  "Scheduled Skill ready": "定时 / 自动触发的 Skill 已就绪",
  "Create skill": "创建 Skill",
  "Create automation": "创建自动化",
  "Create & export skill": "创建并导出 Skill",
  "Create & export automation": "创建并导出自动化",
  "Create scheduled Skill": "创建定时 Skill",
  "Create and export the automation bundle": "创建并导出自动化文件包",
  "Reveal skill": "查看 Skill",
  "Reveal bundle": "查看文件包",
  "Close": "关闭",
  "Add step": "添加步骤",
  "Move up": "上移",
  ...
  "Skill description": "Skill 说明",
  "Automation title": "自动化标题",
  "Automation description": "自动化说明",
  "One-line description of what this skill does": "用一句话说明此 Skill 的作用",
  ...
  "Could not create the skill": "无法创建 Skill",
  ...
  "This tool records your screen and activity so it can turn what you did into a reusable skill. Here is exactly what it captures and what leaves your computer.": "本工具会录制屏幕与操作，并把你的过程转换为可复用 Skill。以下是具体录制内容及会离开本机的数据。",
  ...
  "Route analysis, visual understanding, Skills and Automations through Copilot or your own OpenAI-compatible endpoint.": "通过 Copilot 或你自己的 OpenAI 兼容端点完成分析、视觉理解、Skill 与自动化构建。",
